...
#Region "  Var. privadas de Propriedades "
  Private ppt_strChaveSeguranca As String
  Private ppt_intTamanhoChave As Integer
#End Region
...
#Region "  Propriedades "
  Public Property TamanhoChave() As Integer
    Get
      Return ppt_intTamanhoChave
    End Get
    Set(ByVal value As Integer)
      ppt_intTamanhoChave = value
    End Set
  End Property
  Public Property ChaveSeguranca() As String
    Get
      Return ppt_strChaveSeguranca
    End Get
    Set(ByVal value As String)
      ppt_strChaveSeguranca = value
    End Set
  End Property
#End Region
...
#Region "  Construtor "
  Public Sub New(ByVal strChaveSeguranca As String,
    ...
    Try
      ppt_strChaveSeguranca = strChaveSeguranca
      ppt_intTamanhoChave = intTamanhoChave
      bytChave = New Rfc2898DeriveBytes(ppt_strChaveSeguranca, bytVetorInicializacao)
...
#Region "  Métodos Privados "
  ...
  Private Sub ProcessarBytesAES(ByVal strOrigem As String,
    ...
    Try
      ...
      cryAES.KeySize = ppt_intTamanhoChave
  ...
  Private Sub ProcessarBytesTripleDES(ByVal strOrigem As String,
    ...
    Try
      ...
      ' Configuração para transformação
      cry3DES.KeySize = ppt_intTamanhoChave
      cry3DES.Key = MD5Hash(ppt_strChaveSeguranca)
